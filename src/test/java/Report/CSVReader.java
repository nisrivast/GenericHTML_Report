...
public static void getBuild() throws IOException{
	URL url = new URL(ConfigPropertyReader.getProperty("jenkinsURL") + "lastSuccessfulBuild/");
...
public static void successBuild() throws IOException{
	...
	for(int i=0;count<6;i++){
		...
		URL url1 = new URL(ConfigPropertyReader.getProperty("jenkinsURL") + (Integer.parseInt(bnumber)-i)+"/");
...
public static void writeComparisionCSV() throws IOException{
	...
	bw2 = new BufferedWriter(new FileWriter(ConfigPropertyReader.getProperty("filePath") + "comparison.csv"));
	...
	bw2.append(",");
		...
		String aggregateCSV = ConfigPropertyReader.getProperty("aggrgateCSVPath")  + i + "/" + "Aggregate.csv";
...
public static void readcomparisionCSV() throws IOException{
	String compCSV = ConfigPropertyReader.getProperty("filePath") + "comparison.csv";
